...
def  doAll():
    ...
    global restart
    global name
    fig, (timeGraphChart, perDayChart, timeOther, timeMe, replyOtherChart, replyMeChart) = plt.subplots(6, 1,num=None, figsize=(10, 45), dpi=80, facecolor='w', edgecolor='k')
    ...
    timeGraphChart.set_title("Messages with " + name + "over time")
